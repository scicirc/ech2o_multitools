...
class Config:
    ...
    PATH_SPA_REF = PATH_MAIN+'/Input_Maps_P5_new'  # Inputs maps / veg param
...
class Obs:
    ...
    # Starting date
    lsim = 9674
    # length of the whole simulation (days, here 1997-7-7 : 2023-12-31)
    ...
    saveB = 2192  # Timestep to store times series (see class Obs, default = 1)
    ...
    simbeg = datetime(2003, 7, 7) # going until 2019-12-24
