...
Precipitation = Precip_spin13Y.bin  # Precip rate in meters/second
AirTemperature = Tavg_spin13Y.bin  # Average air temperature in degC
MaxAirTemp = Tmax_spin13Y.bin  # Maximum air temperature in degC
MinAirTemp = Tmin_spin13Y.bin  # Minimum air temperature in degC
RelativeHumidity = RH_spin13Y.bin  # air relative humidity in kPa/kPa
WindSpeed = Windspeed_spin13Y.bin  # Wind speed in meters/second
IncomingLongWave = Ldown_spin13Y.bin  # Downwelling longwave radiation in W/sq.meter
IncomingShortWave = Sdown_spin13Y.bin  # Solar radiation in W/sq.meter
