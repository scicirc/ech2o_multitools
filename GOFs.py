...
def corr(x1, x2):
    """Pearson's correlation coefficient, ignoring nan
...
def rmu(mod, obs):
    """Ratio of mean of mod and obs, ignoring nan
...
def nash_sutcliffe(mod, obs, axis=0, varient='standard', j=1):
